...
Tämän jälkeen loin uuden pdf-tiedoston komennolla `qpdf -empty -- tiedosto.pdf`. Salasin tiedoston komennolla `qpdf --encrypt secret secret 256 -- tiedosto.pdf tiedosto_salainen.pdf`. Tämän jälkeen, kun tiedosto yrittää avata, avaamiseen vaaditaan salasana. 

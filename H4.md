...
Tehtävä jäi kesken, sillä en aluksi saanut asennettua Johnia. 

![Screenshot](https://github.com/user-attachments/assets/a4535056-8eb5-4180-a3ef-af61f64c3424)

Lopulta asennus onnistui, mutta en kerennyt tekemään tehtäviä loppuun. Viimeistelen tehtävät palautuksen jälkeen. 

![Screenshot](https://github.com/user-attachments/assets/5ae47bda-fd70-445a-8769-267f91eed7cf)
...
Tehtävä tehdään myöhässä c)-kohdan ongelmien takia.
...
Hyödynsin tässä tehtävässä 101Labs-ohjeita. 
...
Stack Exchange 2024. SSH returns: no matching host key type found. Their offer: ssh-dss. Luettavissa osoitteessa: https://askubuntu.com/questions/836048/ssh-returns-no-matching-host-key-type-found-their-offer-ssh-dss. 
